...
const SectionsDetails = ({
  ...
  const buyCourse = async () => {
    try {
      ...
      console.log("Не вдалося перевірити курс", err);
  ...
  return (
    <div className="px-6 py-4 flex flex-col gap-5">
      ...
      {isLocked ? (
        <div className="px-10 flex flex-col gap-5 items-center bg-[#FFF8EB]">
          ...
          <p className="text-sm font-bold">
            Відео для цього розділу курсу недоступне. Придбайте курс, щоб отримати доступ!
          </p>
        </div>
      ) : (
        <MuxPlayer
      ...
      <div>
        <h2 className="text-xl font-bold mb-5">Матеріали курсу</h2>
